...
# A helper script to stage deliveries for NF-core RNA-seq BP analysis results
...
if [ "$#" -ne 1 ]
then
  echo "Usage: stage_rnaseq_delivery.sh <PROJECT_NAME>"
  exit 1
fi
...
# Link/copy multiqc report to seqsummaries
mkdir -p "${SEQSUM_DIR}"
